...
if ($id_cmt == '' || $id_cmt == 0) {
    ...
    $limit = 5;
    $db_point = new db_query("SELECT * FROM comment_core_value WHERE id_parent = " . $id_cmt . " ORDER BY id DESC LIMIT $start,$limit");
    $html = '';
    $arr_data = [];
    ...
    $start = $start + $limit;
    $db_count = new db_query("SELECT * FROM comment_core_value WHERE id_parent = " . $id_cmt . " ORDER BY id DESC LIMIT $start,$limit");
    $result = [
        'result' => true,
        'data' => $arr_data,
