...
if ($user_type == 1){
    ...
    $update = new db_query("UPDATE `member_request_join` SET `type_join` = 2, `refuse_forbid` = 1 WHERE `id_user` = '$id_user' AND `user_type` = '$user_type' AND `id_group` = '$id_group'");
}else{
    ...
    $update = new db_query("UPDATE `member_request_join` SET `type_join` = 2, `refuse_forbid` = 1 WHERE `id_user` = '$id_user' AND (`user_type` = 0 OR `user_type` = 2) AND `id_group` = '$id_group'");
}
