...
if (!is_dir('../img/group/cover_img/' . $_SESSION['login']['id'])) {
  mkdir('../img/group/cover_img/' . $_SESSION['login']['id'], 0777, true);
}

$dir = '../img/group/cover_img/' . $_SESSION['login']['id'];
