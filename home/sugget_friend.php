...
<head>
  ...
  <style>
    .sidebar_index_body_detail:nth-child(3) {
      background: #DDDDDD;
      color: white;
    }
    .fr_nav:nth-child(3) {
    ...
    .sidebar_index_body_detail:nth-child(3) .sidebar_index_text{
      color: #4C5BD4;
    }
  </style>
            ...
            ?>
              <div class="center_item">
                ...
                <div class="center_item_detail">
                  ...
                  <button class="center_item_success">Thêm bạn bè</button>
                  <button class="center_item_del">Xóa, gỡ bỏ</button>
                </div>
              </div>
            <?php
            }
...
<script src="../js/sugget_friend.js?v=<?=$version?>" defer></script>
