						...
						<div id="main-exchange">
							...
							<div class="all-question">
								<div class="mid-center">
									...
									$db_knowledge_answer_count = new db_query("SELECT * FROM knowledge_answer WHERE id_company = $id_company " . $qr);
									$db_knowledge_answer = new db_query("SELECT * FROM knowledge_answer WHERE knowledge_answer.id_company = $id_company " . $qr . " ORDER BY knowledge_answer.id DESC");
