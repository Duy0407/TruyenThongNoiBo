...
$select_post = "SELECT * FROM new_feed 
                    ...
                    AND author = $my_id AND author_type = $my_type AND message_tuchoi != '' "; 
        	...
        	<div class="your_content_head_main">
                <?if (count($arr_post) > 0) {?>
            		<div class="your_content_head_main_one">
                        <div class="your_content_head_main_one_text">Bị từ chối . <?=count($arr_post)?></div>
            			...
            			<div class="posts_are_waiting">
                            <?foreach ($arr_post as $key => $row) { 
                                ...
                                <div class="posts_are_waiting_padding" data-id-new="<?=$row['new_id'];?>" data-new-type="<?=$row['new_type']?>" data-new="<?=$row['new_id'];?>">
                                    ...
                                    <div class="posts_are_waiting_three id_post_member">
                                        <div class="btn_my_content2 cusor detail_my_removed_content" data-message="<?=nl2br($row['message_tuchoi'])?>">
...
<script>
	$("#bg_datuchoi").addClass("active_background");
    $("#ic_datuchoi").addClass("colof_icon")
    $("#text_datuchoi").addClass("active_text");

    $("#bg_datuchoi_mb").addClass("active_text border_bt_blue");
