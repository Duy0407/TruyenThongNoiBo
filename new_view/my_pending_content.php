...
$select_post = "SELECT *, 
                    ...
                    FROM new_feed 
                    WHERE `delete` = 0 AND approve = 1 AND position = $id_group AND type = 1 
...
<body>
	<div class="your_content">
        ...
        <div class="your_content_head">
        	<div id="your_content_sidebar">
        		<?php include '../includes/sidebar_your_conntent.php'; ?>
        	</div>

        	<div class="your_content_head_main my_pending_content">
                <?if (count($arr_post) > 0) {?>
            		<div class="your_content_head_main_one">
                        <div class="your_content_head_main_one_text">Đang chờ . <?=count($arr_post)?></div>
            		...
            		<div class="your_content_head_main_tow">
            			<div class="posts_are_waiting box_contain_list_post">
                            <?foreach ($arr_post as $key => $row) {  
                                ...
                                <div class="posts_are_waiting_padding pick_id_post_hide ep_post_detail" data-new="<?=$row['new_id'];?>" data-new_id="<?=$row['new_id'];?>">
                                    <div class="posts_are_waiting_one">
                                        ...
                                        <div class="posts_are_waiting_one_2 click_pp_nho_tb cusor">
                                            ...
                                            <div class="pp_small_notification">
                                                <div class="pp_notification_my_content">
                                                    ...
                                                    <?}?>
                                                    <!-- <div class="pp_notification_my_content_sub">
                                                        <div class="pp_small_notification_ic">
                                                            <img src="../img/image_new/tam_an_post.svg" alt="">
                                                        </div>
                                                        <div class="pp_small_notification_text fig_text_width">Tạm ẩn <?=$db_group_assoc['group_name']?> trong 30 ngày</div>
                                                    </div> -->
                                                    <?php if ($is_follow) { ?>
                                    ...
                                    <div class="posts_are_waiting_three">
                                        <button class="btn_content_gr text_blue ep_post_action1_deatail_edit show_post_schedule" data-new_id="<?=$row['new_id']?>" data-new_type="<?=$row['new_type']?>">Chỉnh sửa bài viết</button>
                                        <button class="btn_content_gr" onclick="xoa_post_group(<?=$row['new_id']?>)">Xóa bài viết</button>
                                    </div>
                                </div>
                            <?}?>
                        </div>
...
<script>
	$("#bg_dangcho").addClass("active_background");
    $("#ic_dangcho").addClass("colof_icon")
    $("#text_dangcho").addClass("active_text");

    $("#bg_dangcho_mb").addClass("active_text border_bt_blue");
