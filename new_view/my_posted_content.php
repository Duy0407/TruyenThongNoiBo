...
$select_post = "SELECT *, 
                    ...
                    FROM new_feed 
                    WHERE `delete` = 0 AND approve = 0 AND position = $id_group AND type = 1 
...
<head>
	...
	<title>Nội dung của bạn đang đăng</title>
</head>
<body>
            ...
            <div class="your_content_head_main">
                <?if (count($arr_post) > 0) {?>
                    <div class="your_content_head_main_one">
                        <div class="your_content_head_main_one_text">Đã đăng . <?=count($arr_post)?></div>
                    ...
                    <div class="your_content_head_main_tow">
                        <div class="posts_are_waiting box_contain_list_post">
                            <?foreach ($arr_post as $key => $row) {   
                                ...
                                ?>
                                <div class="<?=$hide_post?'':'box_hide_post'?> posts_are_waiting_padding pick_id_post_hide ep_post_detail" data-new_id="<?=$row['new_id'];?>">
                                    ...
                                    <div class="posts_are_waiting_three">
                                        <div class="btn_my_content3 cusor">Xem trong nhóm</div>
                                    </div>
                                    <?php if (!$hide_post) { ?>
...
<script>
	$("#bg_dangdang").addClass("active_background");
    $("#ic_dangdang").addClass("colof_icon")
    $("#text_dangdang").addClass("active_text");

    $("#bg_dangdang_mb").addClass("active_text border_bt_blue");
