                ...
                <div class="phai">
                    <ul class="menu">
                        ...
                        <li id="ring" class="ul_pp_menu">
                            ...
                            <div class="popup" id="popup-thongbao">
                                ...
                                <div class="caidat-body">
                                    <ul class="thongbao">
                                        <?php
                                        $db_notify = new db_query("SELECT * FROM notify WHERE id_company = " . $arr_com->com_id . " ORDER BY id DESC");
                        ...
                        <li class="v_header_popup_menu">
                            ...
                            ?>
                            <div class="ep_info2">
                              <a href="/trang-ca-nhan.html" class="ep_info_detail2">
                                <img class="ep_info_detail_avt2" src="<?=$_SESSION['login']['logo']?>" alt="Ảnh lỗi">
                                <span class="ep_sb_name2"><?=$_SESSION['login']['name']?></span>
                            </a>
                            <a href="/page-ban-be.html" class="ep_info_detail2">
                                <img src="../img/ep_icon_friend.svg" alt="Ảnh lỗi">
                                <span class="ep_sb_name2">Bạn bè</span>
                            </a>
                            <a href="/nhom.html" class="ep_info_detail2">
                                <img src="../img/ep_icon_group.svg" alt="Ảnh lỗi">
                                <span class="ep_sb_name2">Nhóm</span>
                            </a>
                            <a href="/bo-suu-tap.html" class="ep_info_detail2">
                                <img src="../img/ep_icon_save.svg" alt="Ảnh lỗi">
                                <span class="ep_sb_name2">Đã lưu</span>
                            </a>
                            <a href="/truyen-thong-noi-bo-su-kien.html" class="ep_info_detail2">
                                <img src="../img/ep_info_event.svg" alt="Ảnh lỗi">
                                <span class="ep_sb_name2">Sự kiện</span>
                            </a>
                            <a class="ep_info_detail2">
                                <img src="../img/ep_info_mess.svg" alt="Ảnh lỗi">
                                <span class="ep_sb_name2">Tin nhắn</span>
                            </a>
                            <a href="/ky-niem.html" class="ep_info_detail2">
                                <img src="../img/ep_info_kn.svg" alt="Ảnh lỗi">
                                <span class="ep_sb_name2">Kỷ niệm</span>
                            </a>
                        </div>
                            <?php
                             } 
