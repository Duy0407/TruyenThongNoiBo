...
<li class="bv-binhchon">
    <div class="baiviets-header">
        <div class="imgtrai avt"><img class="v_avatar_user1" src="<?= $avt_image ?>" onerror='this.onerror=null;this.src="../img/logo_com.png";' alt="Ảnh lỗi"></div>
                            ...
                            while ($row_user = mysql_fetch_array($db_user_vote->result)) {
                                if ($row_user['user_type'] != 1) {
                                    if ($data_ep[$row_user['id_user']]->ep_image) {
                                        ...
                                        $img_avt = 'https://chamcong.24hpay.vn/upload/employee/' . $data_ep2[$row_user['id_user']]->ep_image;
                                    }
                                } else {
                                    $img_avt = 'https://chamcong.24hpay.vn/upload/company/logo/' . array_values($data_ep2)[0]->com_logo;
                                }
                        ?>
                                <div class="img">
                                    <img src="<?= $img_avt ?>">
