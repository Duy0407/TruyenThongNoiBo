<li class="bv-taosukien v_newfeed_li">
    <div class="baiviets-header">
        <div class="imgtrai avt"><img class="v_avatar_user1" src="<?= $avt_image ?>" onerror='this.onerror=null;this.src="../img/logo_com.png";'></div>
        <div class="cont cont_baiviet_tt_sdn">
            <p> <span class="name-st"><?= $newfeed_name ?> </span> <span class="thuong"> đã tạo sự kiện nội bộ: </span> <span class="address-st"><?= $row_newfeed['new_title'] ?></span> </p> <span class="time-st"><?= date("H:i d/m/Y", $row_newfeed['created_at']) ?></span> <span class="thuong">.
                <?php
    ...
    <div class="baiviets-body">
        ...
        <div class="anh">
            <div class="img event_avatar"> <img src="../img/new_feed/event/event_noi_bo/avatar/<?php echo $row_newfeed['author'] . '/' . $row_event['avatar'] ?>">
                <div class="sk-time">
                    <div class="sk-gio">
