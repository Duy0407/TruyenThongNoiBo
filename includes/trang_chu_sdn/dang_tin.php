<li class="v_newfeed_li">
    <div class="baiviets-header">
        <div class="imgtrai avt">
            <img class="v_avatar_user1" src="<?= $avt_image ?>" onerror='this.onerror=null;this.src="../img/logo_com.png";'>
        </div>
        <div class="cont cont_baiviet_tt_sdn">
            <p>
                ...
                <span class="thuong"> đã thêm một tin mới<?php
                if ($name_employee != '') {
                    echo ' cùng với: ';
                }
            ?></span>
        ...
        <div class="popup-chinhsua">
            <div class="ul_model">
                ...
                if ($_SESSION['login']['user_type'] == 2) {
                    ...
                    if ($type_create == 1) {
                        ?>
                        <div class="li_model open_model_edit_nf" data-new_id="<?= $row_newfeed['new_id'] ?>" data-new_type="<?= $row_newfeed['new_type'] ?>">
