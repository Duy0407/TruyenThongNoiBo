<li class="v_newfeed_file">
    <div class="v_newfeed_file_div1">
        ...
        ?>
                <div class="v_newfeed_file_div2"><img class="v_new_feed_image" src="../img/new_feed/discuss/<?=$row_newfeed['author']?>/<?=$file[$i]?>" alt="Ảnh lỗi"></div>
        <?php
                                            ...
                                            <div class="baiviets-header">
                                                ...
                                                <div class="cont cont_baiviet_tt_sdn">
                                                    <p>
                                                        ...
                                                        <span class="thuong"> đã tạo bài thảo luận: </span>
