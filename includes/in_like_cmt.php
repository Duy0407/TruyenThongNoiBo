<div class="reach">
  <div class="lc tren v_active_tren">
    ...
    <div class="phai"> <span class="v_count_comment" id="number_comment<?= $row_newfeed['new_id'] ?>" data-value="<?= mysql_num_rows($db_num_comment->result) ?>"><?= mysql_num_rows($db_num_comment->result) ?> Bình luận</span>
    </div>
  </div>
  <div class="lc duoi v_active_duoi">
    ...
    <div class="phai" onclick="focus_comment(<?= $row_newfeed['new_id'] ?>);"> <img src="../img/icon_cmt.png"> <span>Bình luận</span>
    </div>
  </div>
</div>