...
//Ảnh bìa
// if ($group_name != "" && $id_manager != "" && $description != "" && $id_employee != "" && $group_mode != "" && isset($_FILES['cover_image']) && isset($_FILES['group_image'])) {
...
$folder_group_image = "../img/group/group_image/" . $_SESSION['login']['id_com'];
